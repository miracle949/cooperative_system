                ...
                <div class="col-lg-4 mt-4">
                    <div class="row">
                        <div class="col-lg-9" style="padding: 0 0 0 12px">
                            ...
                            <input type="text" name="tricycle_plate_no" id="" class="form-control mt-1" onkeydown=" if (event.key === '+' || event.key === '=' || event.key === '?' || event.key === '.' || event.key === ',' || event.key === '(' || event.key === ')') event.preventDefault();">
                            <div class="reminder">
                                <span>Enter plate number</span>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <label>#</label>
                            <input type="number" name="total_tricycle" id="" class="form-control mt-1" min="0" onkeydown=" if(event.key === 'e' || event.key === 'E' || event.key === '+' || event.key === '-') event.preventDefault();">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-2 mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="are_you_willing_liability" id="liabilityYes"
                            value="1">
                ...
                <div class="col-lg-2 mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="are_you_willing_liability" id="liabilityNo"
                            value="0">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 mt-4">
            ...
            <div class="row">
                <div class="col-lg-2 mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="are_you_willing_abide_policy" id="abideYes"
                            value="1">
                ...
                <div class="col-lg-2 mt-2">
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="are_you_willing_abide_policy" id="abideNo"
                            value="0">
