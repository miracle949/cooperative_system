...
<body>
    ...
    <div class="container-fluid p-0 m-0">
        ...
        <div class="main-parent-center">
            <div class="left-main">
                <main>
                    @if ($username)
                        <div class="main-header">
                            <div class="main-intro">
                                <p class="" style="letter-spacing: 2px;">Member Cooperative Portal</p>
                                                    ...
                                                    @if($penaltyInfo)
                                                        <div class="parent-box" style="margin-top: 10px;">
                                                            <div class="box remaining-balance"
                                                                ...
                                                                <p style="color: #dc2626;">Late Fee ({{ $penaltyInfo['months_overdue'] }}
                                                                    month(s)
                                                                    overdue)</p>
                                                ...
                                                <div class="box-footer">
                                                    ...
                                                    <div class="box-approved">
                                                        ...
                                                        @elseif ($loan->status === 'Pending')
                                                            ...
                                                            <p style="color: #e6a817; font-weight: 600; margin: 0;">Awaiting admin review
                                                            </p>
