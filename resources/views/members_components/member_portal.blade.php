...
<head>
    ...
    <style>
        /* Standalone message styles — works regardless of position in DOM */
        .toast-message {
            position: fixed;
            right: 20px;
            top: 20px;
...
<body>
                    ...
                    @if ($username)
                        <div class="main-header">
                            <div class="main-intro">
                                <div class="main-intro-icon">

                                </div>
                                <div class="main-intro-text">
                                    <p class="" style="letter-spacing: .16em;">Member Cooperative Portal</p>
                                ...
                                <div class="parent-loan">
                                    @foreach ($loans as $loan)
                                         ...
                                         <div
                                                                                ...
                                                                                @if($penaltyInfo)
                                                                                    <div class="box-icon"
                                                                                        style="background: #fef2f2; border: 1.5px solid #dc2626; border-radius: 20px; padding: 4px 12px; display: flex; align-items: center; gap: 6px;">
                                                                                        <div class="dot"
                                                                                            style="width: 7px; height: 7px; border-radius: 50%; background: #dc2626; flex-shrink: 0;">
                                                                                        </div>
                                                                                        <span
                                                                                            style="color: #dc2626; font-size: 12px; font-weight: 700;">Overdue</span>
                                                                                    </div>
                                                                                @else
                                                                                    <div class="box-icon"
                                                                            ...
                                                                            @if($penaltyInfo)
                                                                                <div class="parent-box" style="margin-top: 10px;">
                                                                                    <div class="box remaining-balance"
                                                                                        ...
                                                                                        <p style="color: #dc2626;">Late Fee
                                                                                            ({{ $penaltyInfo['months_overdue'] }}
                                                                                            month(s)
                                                                                            overdue)</p>
                                                                                        <h5 style="color: #dc2626;">
                                                                                            ₱{{ number_format($penaltyInfo['late_fee'], 2) }}</h5>
                                                                                    </div>
                                                                                </div>
                                                                            @endif
                                                                        ...
                                                                        <div class="box-footer">
                                                                            <div class="box-approved">
                                                                                @if ($loan->status === 'Approved')
                                                                                    ...
                                                                                    <p style="color: #1a4a3a; font-weight: 600; margin: 0;">
                                                                                        Approved on
                                                                                        {{ \Carbon\Carbon::parse($loan->updated_at)->format('F d, Y') }}
                                                                                    </p>
                                                                                @elseif ($loan->status === 'Pending')
                                                                                    <i class="fa fa-hourglass" style="color: #e6a817;"></i>
                                                                                    <p style="color: #e6a817; font-weight: 600; margin: 0;">Awaiting admin
                                                                                        review
                                                                                    </p>
                                                                            ...
                                                                            <div class="box-link">
                                                                                @if ($loan->status === 'Rejected' || $loan->status === 'Declined')
                                                                                    ...
                                                                                    <a href="{{ route("LoanApplication") }}">Re-apply <i
                                    ...
                                    <div class="member-body">
                                        <div class="body-text">
                                            ...
                                            @if ($member->approval_status === "Pending")
                                                <span
                                                    style="color: var(--gold)">{{ $member->approval_status ?? 'N/A' }}</span>
                                            @elseif($member->approval_status === "Declined")
                                                <span style="color: #DC2626">{{ $member->approval_status ?? 'N/A' }}</span>
                                            @else
                                                <span
                                                    style="color: #1a4a3a; font-weight: 600;">{{ $member->approval_status ?? 'N/A' }}</span>
                                            @endif
                                        </div>
                                        <div class="body-text">
                                            <p>Member Since:</p>
                                        ...
                                        <div class="body-text">
                                            ...
                                            <div class="membership_status">
                                                @if ($member->membership_status === "Unofficial")
                                                    ...
                                                    <span
                                                        style="color: var(--gold)">{{ $member->membership_status ?? 'N/A' }}</span>
                                                @elseif($member->membership_status === "Not Active")
                                                    <div class="dot"
                                                        style="width: 8px; height: 8px; background-color: #DC2626; border-radius: 50%">
                                                    </div>
                                                    <span
                                                        style="color: #DC2626">{{ $member->membership_status ?? 'N/A' }}</span>
                                                @else
                                                    <div class="dot"
                                                        style="width: 8px; height: 8px; background-color: #1a4a3a; border-radius: 50%">
                                                    </div>
                                                    <span
                                                        style="color: #1a4a3a; font-weight: 600;">{{ $member->membership_status ?? 'N/A' }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
    ...
    {{-- ✅ Toast message: outside container-fluid, uses its own .toast-message class --}}
    @if (session("message"))
